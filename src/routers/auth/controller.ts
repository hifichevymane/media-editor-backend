...
export default class AuthController {
  public static async signUp(req: SignUpRequest, res: Response): Promise<void> {
    const {
      username, email,
      password,
  ...
  public static async login(req: LoginRequest, res: Response): Promise<void> {
  ...
  public static async updateUser(req: UpdateUserRequest, res: Response): Promise<void> {
    try {
